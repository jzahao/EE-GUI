...
# Background
background_img = PhotoImage(file = f"bg_translator_vitoeng.png")
...
# Button: Swap
button_swap_img = PhotoImage(file = f"translator_button_swap_2.png")
button_swap = Button(
...
# Button: Clear
button_clear_img = PhotoImage(file = f"translator_button_clear_2.png")
button_clear = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
...
# Button: Trans
button_trans_img = PhotoImage(file = f"translator_button_trans_2.png")
button_trans = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
