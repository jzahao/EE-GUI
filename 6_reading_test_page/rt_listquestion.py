...
# Background
background_img = PhotoImage(file = f"bg_rt_listquestion.png")
...
button_ywa_img = PhotoImage(file = f"rt_button_ywa.png")
button_ywa = Button(
...
img = PhotoImage(file = f"rt_button_question.png")
img_true = PhotoImage(file = f"rt_button_true.png")
img_false = PhotoImage(file = f"rt_button_false.png")
...
# Button: Back
button_back_img = PhotoImage(file = f"rt_button_back_1.png")
button_back = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
