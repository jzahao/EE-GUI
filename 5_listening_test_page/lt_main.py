...
# Background
background_img = PhotoImage(file = f"bg_lt_main.png")
...
# Button: LT
button_lt_img = PhotoImage(file = f"lt_button_listeningtest.png")
button_lt = Button(
    activebackground = "#B31217",
...
# Button: Test 1
button_test1_img = PhotoImage(file = f"lt_button_test1.png")
button_test1 = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
...
# Button: Test 2
button_test2_img = PhotoImage(file = f"lt_button_test2.png")
button_test2 = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
...
# Button: Test 3
button_test3_img = PhotoImage(file = f"lt_button_test3.png")
button_test3 = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
...
# Button: Test 4
button_test4_img = PhotoImage(file = f"lt_button_test4.png")
button_test4 = Button(
    activebackground = "#EDDBDB",
    bg = "#EDDBDB",
